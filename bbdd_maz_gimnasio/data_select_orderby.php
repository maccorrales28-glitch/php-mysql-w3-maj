...
<head>
    <meta charset="UTF-8">
    <title>Listado Ordenado (A-Z)</title>
...
<div class="container mt-4">
    <h1>Listado de Socios (Orden Alfabético)</h1>

    <?php
    if ($result && mysqli_num_rows($result) > 0) {
        echo "<table class=\"table table-striped table-hover\">";
        echo "<thead><tr><th>ID</th><th>Nombre Socio</th><th>Suscripción</th><th>Zona</th><th>Fecha</th></tr></thead>";
        echo "<tbody>";
